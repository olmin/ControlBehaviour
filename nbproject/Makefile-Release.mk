...
${OBJECTDIR}/MySQLConnector.o: MySQLConnector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/MySQLConnector.o MySQLConnector.cpp

${OBJECTDIR}/controlBehaviour.o: controlBehaviour.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/controlBehaviour.o controlBehaviour.cpp
